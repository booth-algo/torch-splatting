...
class GaussModel(nn.Module):
    ...
    * Attributes
    ...
    def __init__(self, sh_degree : int=3, debug=False, sample_size=1000):
        ...
        self._percent_dense = 0.1
        self._xyz_gradient_accum = torch.zeros((sample_size, 1), device="cuda")
        self._denom = torch.zeros((sample_size, 1), device="cuda")
        self._max_radii2D = torch.zeros((sample_size), device="cuda")
    ...
    def create_from_pcd(self, pcd:PointCloud):
        ...
        self._max_radii2D = torch.zeros((self._xyz.shape[0]), device="cuda")
        return self
    ...
    def get_xyz_gradient_accum(self):
        return self._xyz_gradient_accum
    
    def get_percent_dense(self):
        return self._percent_dense
    ...
    def forward(self):
        ...
        return {
            ...
            'percent_dense': self.get_percent_dense(),
            'xyz_gradient_accum': self.get_xyz_gradient_accum(),
            'denom': self.get_denom(),
            'max_radii2D': self.get_max_radii2D()
        }
