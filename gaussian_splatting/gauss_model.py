...
class GaussModel(nn.Module):
    ...
    * Attributes
    ...
    def __init__(self, sh_degree : int=3, debug=False, sample_size=1000):
        ...
        self.percent_dense = 0.1  # Set default or parameterize as needed
        self.xyz_gradient_accum = torch.zeros((sample_size, 1), device="cuda")
        self.denom = torch.zeros((sample_size, 1), device="cuda")
        self.max_radii2D = torch.zeros((sample_size), device="cuda")
